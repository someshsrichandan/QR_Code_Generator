...
function App() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] from-slate-900 via-purple-900 to-slate-900 p-4">
      <div className="w-full max-w-3xl h-full max-h-[90vh] border border-white rounded-xl shadow-gradient p-4 flex flex-col gap-6 overflow-hidden">
        ...
        <div className="flex flex-col-reverse md:flex-row justify-around gap-6 md:gap-10 p-4 flex-grow items-center overflow-auto">
